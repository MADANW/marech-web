...
export function Footer() {
  return (
    <footer className="bg-black/40 backdrop-blur-xl border-t border-white/10 text-white/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            <h3 className="text-white/80 text-sm font-semibold mb-3">Product</h3>
          ...
          <div>
            <h3 className="text-white/80 text-sm font-semibold mb-3">Legal</h3>
            <ul className="space-y-2 text-sm">
